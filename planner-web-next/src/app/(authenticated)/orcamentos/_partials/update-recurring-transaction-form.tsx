...
interface Props {
  ...
  handleUpdate?: (data: UpdateRecurringTransactionDto) => void
  isLoading?: boolean
  className?: ClassNameValue
}

export default function UpdateRecurringTransactionForm({ transaction, handleUpdate, isLoading, className }: Props) {
  const form = useForm<z.infer<typeof formSchema>>({
    resolver: zodResolver(formSchema),
    defaultValues: {
      description: transaction?.description,
      referenceValue: transaction?.referenceValue,
      type: transaction?.type,
      paymentMethod: transaction?.paymentMethod,
      startDate: transaction?.startDate,
      endDate: transaction?.endDate || undefined,
      frequency: transaction?.frequency,
      expectedDayOfMonth: transaction?.expectedDayOfMonth || undefined,
      expectedDayOfWeek: transaction?.expectedDayOfWeek || undefined,
      expectedMonthOfYear: transaction?.expectedMonthOfYear || undefined,
    },
  })
