  ...
  return (
    <div className='py-4 max-w-screen-2xl mx-auto'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-12 gap-4 pt-6'>
        <SummaryCard title="Saldo" amount={transactions?.summary.balance} className="sm:col-span-4" Icon={DollarSignIcon} amountTextClassName="sm:text-4xl" />
        <div className="hidden sm:block col-span-4 bg-primary"></div>
        <SummaryCard title="Receitas" amount={transactions?.summary.income} className="sm:col-span-2" Icon={TrendingUpIcon} />
        <SummaryCard title="Despesas" amount={transactions?.summary.expense} className="sm:col-span-2" Icon={TrendingDownIcon} useSecondaryBackground />
        <SummaryCard title="Investido" amount={transactions?.summary.invested} className="sm:col-span-2" Icon={PiggyBankIcon} useSecondaryBackground />
        <SummaryCard title="Caixinhas" amount={transactions?.summary.wallet} className="sm:col-span-2" Icon={WalletIcon} useSecondaryBackground />
        <SummaryChart year={year} month={month} summary={transactions?.summary} className="sm:col-span-5" />
